...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "PayrollApp.controller.Main": [],
  "PayrollApp.controller.MainApp": [],
  "PayrollApp.controller.UserManagement": [],
  "PayrollApp.controller.deleteActions": [],
  "PayrollApp.model.BankBranches": [],
  "PayrollApp.model.Banks": [],
  "PayrollApp.model.CompanyInfo": [],
  "PayrollApp.model.Deductions": [],
  "PayrollApp.model.DefaultItems": [],
  "PayrollApp.model.DeptBranch": [],
  "PayrollApp.model.Earnings": [],
  "PayrollApp.model.EmpPayments": [],
  "PayrollApp.model.EmployeesList": [],
  "PayrollApp.model.EmployeesRegister": [],
  "PayrollApp.model.EmploymentType": [],
  "PayrollApp.model.JobGroups": [],
  "PayrollApp.model.JobTitles": [],
  "PayrollApp.model.MaritalStatus": [],
  "PayrollApp.model.NHIFReturns": [],
  "PayrollApp.model.NssfReturns": [],
  "PayrollApp.model.PayDepartments": [],
  "PayrollApp.model.PayRates": [],
  "PayrollApp.model.PayTypes": [],
  "PayrollApp.model.PayeReturns": [],
  "PayrollApp.model.PaymentsSummary": [],
  "PayrollApp.model.PayrollListings": [],
  "PayrollApp.model.PayrollMonths": [],
  "PayrollApp.model.PayrollPostings": [],
  "PayrollApp.model.ProllLocaldata": [],
  "PayrollApp.model.ProllPayments": [],
  "PayrollApp.model.SlipEmpInfo": [],
  "PayrollApp.model.TrialBalance": [],
  "PayrollApp.model.UserRoles": [],
  "PayrollApp.model.UsersList": [],
  "PayrollApp.store.BankBrancheStore": [],
  "PayrollApp.store.BankStore": [],
  "PayrollApp.store.CompanyInfoStore": [],
  "PayrollApp.store.DefaultItemsStore": [],
  "PayrollApp.store.EmpPaymentStore": [],
  "PayrollApp.store.EmpRegisterStore": [],
  "PayrollApp.store.EmpTypesStore": [],
  "PayrollApp.store.EmployeeListStore": [],
  "PayrollApp.store.JobGroupStore": [],
  "PayrollApp.store.JobTitlesStore": [],
  "PayrollApp.store.LocalDataStore": [],
  "PayrollApp.store.MaritalStatusStore": [],
  "PayrollApp.store.NhifReturnsStore": [],
  "PayrollApp.store.NssfReturnsStore": [],
  "PayrollApp.store.PayBranchStore": [],
  "PayrollApp.store.PayDeptStore": [],
  "PayrollApp.store.PayMonthStore": [],
  "PayrollApp.store.PayRatesStore": [],
  "PayrollApp.store.PayTypeStore": [],
  "PayrollApp.store.PayeReturnsStore": [],
  "PayrollApp.store.PaymentsSummaryStore": [],
  "PayrollApp.store.PayrollListingsStore": [],
  "PayrollApp.store.PayrollPostingStore": [],
  "PayrollApp.store.ProllPaymentsStore": [],
  "PayrollApp.store.SlipEmpInfoStore": [],
  "PayrollApp.store.TrialBalanceStore": [],
  "PayrollApp.store.UserRolesStore": [],
  "PayrollApp.store.UsersListStore": [],
  "PayrollApp.view.BankBranches": [],
  "PayrollApp.view.BankPayments": [],
  "PayrollApp.view.Banks": [],
  "PayrollApp.view.CompanySettings": [],
  "PayrollApp.view.Departments": [],
  "PayrollApp.view.EmpPayments": [],
  "PayrollApp.view.EmployeeRegister": [],
  "PayrollApp.view.JobGroups": [],
  "PayrollApp.view.JobTitles": [],
  "PayrollApp.view.Main": [],
  "PayrollApp.view.NewPaymentsForm": [],
  "PayrollApp.view.NewUserForm": [],
  "PayrollApp.view.NhifReturns": [],
  "PayrollApp.view.NssfReturns": [],
  "PayrollApp.view.PayRatesForm": [],
  "PayrollApp.view.PayTypesForm": [],
  "PayrollApp.view.PayeReturns": [],
  "PayrollApp.view.PayrollBranches": [],
  "PayrollApp.view.PayrollListingGrid": [],
  "PayrollApp.view.PayrollMain": [],
  "PayrollApp.view.PayrollPostingGrid": [],
  "PayrollApp.view.PayrollPostingWindow": [],
  "PayrollApp.view.PayslipsWin": [],
  "PayrollApp.view.PostPayroll": [],
  "PayrollApp.view.ProcessPayroll": [],
  "PayrollApp.view.RegisterForm": [],
  "PayrollApp.view.RegisterWindow": [],
  "PayrollApp.view.ReportsMainView": [],
  "PayrollApp.view.TrialBalanceWindow": [],
  "PayrollApp.view.UserManagement": [],
  "PayrollApp.view.Viewport": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "PayrollApp.model.PayrollListings": [
    "model.payrolllistings"
  ],
  "PayrollApp.model.PayrollMonths": [],
  "PayrollApp.model.PayrollPostings": [
    "model.payrollpostings"
  ],
  "PayrollApp.model.ProllLocaldata": [
    "model.prolllocaldata"
  ],
  "PayrollApp.model.ProllPayments": [
    "model.prollpayments"
  ],
  ...
  "PayrollApp.view.Departments": [
    "widget.departmentsform"
  ],
  "PayrollApp.view.EmpPayments": [
    "widget.emppayments"
  ],
  "PayrollApp.view.EmployeeRegister": [
    "widget.employeeregister"
  ],
  "PayrollApp.view.JobGroups": [
    "widget.jobgroups"
  ],
  ...
  "PayrollApp.view.PayrollBranches": [
    "widget.payrollbranches"
  ],
  "PayrollApp.view.PayrollListingGrid": [
    "widget.payrolllistinggrid"
  ],
  "PayrollApp.view.PayrollMain": [
    "widget.payrollmain"
  ],
  "PayrollApp.view.PayrollPostingGrid": [
    "widget.payrollpostinggrid"
  ],
  "PayrollApp.view.PayrollPostingWindow": [
    "widget.payrollpostingwindow"
  ],
  "PayrollApp.view.PayslipsWin": [
    "widget.payslipswin"
  ],
  ...
  "PayrollApp.view.ReportsMainView": [
    "widget.reportsmainview"
  ],
  "PayrollApp.view.TrialBalanceWindow": [
    "widget.trialbalancewindow"
  ],
  "PayrollApp.view.UserManagement": [
