 ...
 * Date: Fri Aug 25 2023 12:37:57 GMT+0300 (East Africa Time)
 *
...
Ext.define('PayrollApp.controller.MainApp', {
    ...
    getLoggedUser: function(component, eOpts) {
        ...
        User2.load({
            ...
            callback: function(records, operation, success) {
                 var data1=this.getStore('EmpPaymentsStore').getAt(0);
        ...
        User2.load({
          params: {
            ...
            callback: function(records, operation, success) {
                ...
                component.setValue("<b>PAYROLL</b>");
            },
            scope: this
    ...
    loadEmployeePayments: function(gridpanel, record, item, index, e, eOpts) {
        ...
        var emppaymentstore=Ext.data.StoreManager.lookup('EmpPaymentsStore');
