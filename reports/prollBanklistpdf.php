...
//    $page = new Zend_Pdf_Page(Zend_Pdf_Page::SIZE_A4);
    ...
    $page->drawText($address.','.$town.','.$country.','.$postal.',Tel:'.$tel, $leftPos + 190, $topPos - 45);
    ...
    $sqlc="Select BankBranch from proll_bankbranches where ID='$branchID'";
    ...
    $page->drawText(ucwords(strtolower($rowc[0])), $leftPos + 20, $topPos - 110);
...
//        }
    ...
    $page->setLineWidth(0.5);
    $page->drawLine($leftPos + 370, $topPos, $leftPos + 450, $topPos, Zend_Pdf_Page::SHAPE_DRAW_STROKE);
    ...
    $pdfBase->drawText($page, "Ksh ".number_format($total,2), $leftPos + 450, $topPos - 10,$leftPos + 450,right);
